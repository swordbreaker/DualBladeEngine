...
public interface IPhysicsManager
{
    ...
    Body CreateBody(Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);
    void Clear();
    Body CreateEdge(Vector2 start, Vector2 end);
    Body CreateChainShape(Vertices vertices, Vector2 position = default(Vector2));
    Body CreateLoopShape(Vertices vertices, Vector2 position = default(Vector2));
    Body CreateRectangle(float width, float height, float density, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);
    Body CreateCircle(float radius, float density, Vector2 position = default(Vector2), BodyType bodyType = BodyType.Static);
    Body CreateEllipse(float xRadius, float yRadius, int edges, float density, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);
    Body CreatePolygon(Vertices vertices, float density, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);

    Body CreateCompoundPolygon(List<Vertices> list, float density, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);

    Body CreateGear(float radius, int numberOfTeeth, float tipPercentage, float toothHeight, float density, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);

    Body CreateCapsule(float height, float topRadius, int topEdges, float bottomRadius, int bottomEdges, float density, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);

    Body CreateCapsule(float height, float endRadius, float density, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);

    Body CreateRoundedRectangle(float width, float height, float xRadius, float yRadius, int segments, float density, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);

    Body CreateLineArc(float radians, int sides, float radius, bool closed = false, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);

    Body CreateSolidArc(float density, float radians, int sides, float radius, Vector2 position = default(Vector2), float rotation = 0f, BodyType bodyType = BodyType.Static);
